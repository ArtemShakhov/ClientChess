...
public class Server {
    ...
    public static void main(String[] args) throws IOException{
        ...
        while(true) {
            ...
            playerNo++;
          //  JOptionPane.showMessageDialog(null, "[Server] Игрок " + playerNo++ + " подключился.");
...
class ClientHandler implements Runnable {
    ...
    public boolean checkGameStatus() {
        if(points == 8) {
            if(id == 1) {
                ...
                System.out.printf("Победа Черных!\n");
            }
            System.out.println("Все пешки одного игрока съедены!\n");
            System.exit(0);
            return true;
        }
        return false;
    ...
    private void checkWinning(String cmd) {
        ...
        if(moveArray[1] != moveArray[3]) {
            System.out.println("Произошло поедание!\n");
            points++;
        }
